    ...
    def _on_monitor_changed(self):
        if (self.is_enabled() and (self.m_oMonitorButton != None)):
            ...
            if oTrack != None:
                ...
                if nMonitor == 0: # In
                    self.m_oMonitorButton.set_light('Mixer.Monitor.In')
                elif nMonitor == 1: # Auto
                    self.m_oMonitorButton.set_light('Mixer.Monitor.Auto')
                else: # nMonitor == 2: # Off
                    self.m_oMonitorButton.set_light('Mixer.Monitor.Off')
            else:
                self.m_oMonitorButton.set_light('Mixer.Monitor.Unav')
